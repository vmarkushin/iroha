...
pub mod isi {
    ...
    impl Peer {
        ...
        pub fn register_bridge(&self, bridge_definition: BridgeDefinition) -> Instruction {
            ...
            let account = Account::unowned("bridge", &domain.name);
            Instruction::If(
    ...
    mod tests {
        ...
        impl TestKit {
            pub fn new() -> Self {
                ...
                let bridge_asset =
                    Asset::with_permission(bridge_asset_id.clone(), Permission::Anything);
        ...
        fn test_register_bridge_test_should_pass() {
            ...
            let bridge_owner_account =
                Account::new("bridge_owner", "Company", bridge_owner_public_key);
